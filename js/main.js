...
$(function(){
    ...
    $('.cat-h-link').on('click', function(e) {
        e.stopPropagation();
        e.preventDefault();
        $(this).children('.burger').toggleClass('open');
        $('.dd-cat').toggleClass('opened');
        if ($('.dd-cat').hasClass('opened')) {
    ...
    $('.btn-show-more').on('click', function() {
        if (!$(this).hasClass('showing')) {
            $(this).siblings('.cutted').css({'display': 'block'})
            .addClass('no-grad');
            $(this).text("Скрыть").addClass('showing');
        }
        else {
            $(this).siblings('.cutted').css({'display': '-webkit-box'})
            .removeClass('no-grad');
            $(this).text("Читать далее").removeClass('showing');
        }
    })
